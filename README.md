...
Данное приложение предлагает пользователю использовать GUI (graphical user interface) при работе в терминале. Такая возможность предоставляется при использовании библиотеки **curses.h**.
