...
Данное приложение предлагает пользователю использовать GUI (graphical user interface) при работе в терминале. Такая возможность, при разработке, предоставляется библиотекой **curses.h**.
